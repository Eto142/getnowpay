            ...
            <div class="card mb-4">
                ...
                <div class="card-body pt-0">
                        ...
                        <div class="col-md-6 col-lg-3 mb-3">
                            <div class="card stat-card bg-danger bg-opacity-10 border-danger h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="value fs-3 fw-bold">{{ number_format($totalEscrowCount) }}</div>
                                            <div class="label text-muted">Active Escrows</div>
                                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4 col-lg-3 mb-3">
                            <div class="card stat-card bg-secondary bg-opacity-10 border-secondary h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="value fs-3 fw-bold">{{ $totalPaymentinfoCount }}</div>
                                            <div class="label text-muted">Bank Information</div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <div class="label text-muted">Transaction Agreements</div>
                                        </div>
                                        <div class="bg-warning bg-opacity-25 p-3 rounded">
                                            <i class="fas fa-file-contract text-warning fs-4"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-lg-3 mb-3">
                            <div class="card stat-card bg-purple bg-opacity-10 border-purple h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="value fs-3 fw-bold">7</div>
                                            <div class="label text-muted">Connected Escrows</div>
                                        </div>
                                        <div class="bg-purple bg-opacity-25 p-3 rounded">
                                            <i class="fas fa-link text-purple fs-4"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-lg-3 mb-3">
                            <div class="card stat-card bg-teal bg-opacity-10 border-teal h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="value fs-3 fw-bold">{{ $totalPaymentproofCount }}</div>
                                            <div class="label text-muted">Payment Proofs</div>
                                        </div>
                                        <div class="bg-teal bg-opacity-25 p-3 rounded">
                                            <i class="fas fa-receipt text-teal fs-4"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
